...
#TARGET_RECOVERY_UI_LIB := librecovery_ui_wing_clover
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/softwinner/wing-clover/bluetooth/

DEVICE := device/softwinner/wing-clover
